  ...
  Widget build(BuildContext context) {
    return Container(
      margin: EdgeInsets.only(
        bottom: marginBottom ??
            screenSize.height * SizeGlobalVariables.point_zero_two,
      ),
      padding: EdgeInsets.symmetric(
        horizontal: paddingHorizontal ??
            SizeGlobalVariables.double_size_twelve,
      ...
      decoration: BoxDecoration(
        ...
        borderRadius:
        BorderRadius.circular(SizeGlobalVariables.double_size_eight),
        boxShadow: isBoxShadowFeatureRequired
          ...
          const BoxShadow(
            ...
            : [],
        border: isBoxShadowFeatureRequired
            ? Border.all(
