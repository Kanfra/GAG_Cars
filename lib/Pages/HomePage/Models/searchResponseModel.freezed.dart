...
mixin _$SearchResponse {
 ...
 bool get success; String get message; List<SearchItem>? get data;
...
@useResult
$Res call({
 bool success, String message, List<SearchItem>? data
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool success,  String message,  List<SearchItem>? data)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SearchResponse() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool success,  String message,  List<SearchItem>? data)  $default,) {final _that = this;
switch (_that) {
case _SearchResponse():
return $default(_that.success,_that.message,_that.data);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool success,  String message,  List<SearchItem>? data)?  $default,) {final _that = this;
switch (_that) {
case _SearchResponse() when $default != null:
return $default(_that.success,_that.message,_that.data);case _:
  return null;
...
class _SearchResponse implements SearchResponse {
  const _SearchResponse({required this.success, required this.message, final  List<SearchItem>? data}): _data = data;
