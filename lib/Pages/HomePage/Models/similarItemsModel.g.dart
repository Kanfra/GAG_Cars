...
_SimilarItemsResponse _$SimilarItemsResponseFromJson(
...
Map<String, dynamic> _$SimilarItemsResponseToJson(
  _SimilarItemsResponse instance,
) => <String, dynamic>{
  'data': instance.data,
...
_SimilarItem _$SimilarItemFromJson(Map<String, dynamic> json) => _SimilarItem(
...
Map<String, dynamic> _$SimilarItemToJson(_SimilarItem instance) =>
    <String, dynamic>{
      'id': instance.id,
