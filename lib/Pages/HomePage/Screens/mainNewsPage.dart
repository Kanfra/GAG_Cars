        ...
        child: Row(
          ...
          children: [
            Icon(
              icon,
              size: 18,
              color: iconColor ?? (isActive ? ColorGlobalVariables.brownColor : Colors.grey.shade600),
            ),
            ...
            Text(
              ...
              style: TextStyle(
                fontSize: 13,
                fontWeight: FontWeight.w600,
                color: isActive ? ColorGlobalVariables.brownColor : Colors.grey.shade600,
              ),
            ),
          ],
        ),
                  ...
                  child: Container(
                    ...
                    child: IconButton(
                      icon: Icon(
                        ...
                        size: 18,
                        color: _isBookmarked ? ColorGlobalVariables.brownColor : ColorGlobalVariables.blackColor,
                      ),
